...
public class OfficeDetail {
    ...
    private String subscrpt_rcept_bgnde; //오피스텔/도시형/민간임대 청약접수시작일           
    private String subscrpt_rcept_endde; //오피스텔/도시형/민간임대 청약접수종료일   
    private int tot_suply_hshldco;			//공급규모
	public OfficeDetail() {
		super();
		// TODO Auto-generated constructor stub
	}
	public OfficeDetail(int officeDno, String bsns_mby_nm, String cntrct_cncls_bgnde, String cntrct_cncls_endde,
			String hmpg_adres, String house_dtl_secd_nm, int house_manage_no, String house_nm, String house_secd_nm,
			String hssply_adres, String hssply_zip, String mdhs_telno, String mvn_prearnge_ym, int pblanc_no,
			String pblanc_url, String przwner_presnatn_de, String rcrit_pblanc_de, String subscrpt_rcept_bgnde,
			String subscrpt_rcept_endde, int tot_suply_hshldco) {
		super();
		this.officeDno = officeDno;
	...
	public String toString() {
		return "OfficeDetail [officeDno=" + officeDno + ", bsns_mby_nm=" + bsns_mby_nm + ", cntrct_cncls_bgnde="
				+ cntrct_cncls_bgnde + ", cntrct_cncls_endde=" + cntrct_cncls_endde + ", hmpg_adres=" + hmpg_adres
				+ ", house_dtl_secd_nm=" + house_dtl_secd_nm + ", house_manage_no=" + house_manage_no + ", house_nm="
				...
				+ ", rcrit_pblanc_de=" + rcrit_pblanc_de + ", subscrpt_rcept_bgnde=" + subscrpt_rcept_bgnde
				+ ", subscrpt_rcept_endde=" + subscrpt_rcept_endde + ", tot_suply_hshldco=" + tot_suply_hshldco + "]";
	}
	public int getOfficeDno() {
		return officeDno;
	}
	public void setOfficeDno(int officeDno) {
		this.officeDno = officeDno;
	}
