...
public class LoanMortgageAPI {

	public static final String KEY = "781549c1ac8e3a2e2521b79f392e648e";
	public static final String MORTAGE_JSON_URL = "http://finlife.fss.or.kr/finlifeapi/mortgageLoanProductsSearch.json";
	...
	public static List<LoanMortgage> parsingMortgage(String topFinGrpNo, int pageNo) {
		List<LoanMortgage> list = new ArrayList<LoanMortgage>();
		try {
			...
			for (int page = 1; page <= max_page_no; page++) {
				...
				for (int i = 0; i < baseList.size(); i++) {
					...
					long loan_lmt = getLongData(object, "loan_lmt");
					...
					for (int j = 0; j < optionList.size(); j++) {
						...
						if (getStrData(object2, "fin_co_no").equals(fin_co_no)) {
							String mrtg_type = getStrData(object2, "mrtg_type");
							String mrtg_type_nm = getStrData(object2, "mrtg_type_nm");
							...
							LoanMortgage lm = new LoanMortgage(LoanMortgageNo, dcls_month, fin_co_no, kor_co_nm, fin_prdt_cd, fin_prdt_nm, join_way, loan_inci_expn, erly_rpay_fee, dly_rate, loan_lmt, dcls_strt_day, dcls_end_day, fin_co_subm_day, mrtg_type, mrtg_type_nm, rpay_type, rpay_type_nm, lend_rate_type, lend_rate_type_nm, lend_rate_min, lend_rate_max, lend_rate_avg);
							list.add(lm);

							// TODO 데이터가 너무 많아서 주석처리함
//							System.out.println(lm.toString() + "삽입 완료!");
						}
					} // option for문 끝
	...
	public static void lmMainmenu() {
		...
		while (true) {
			...
			while (true) {
				...
				switch (select) {
				case 1:
					parsingMortgage("020000", 1);
					System.out.println("완료되었습니다!!");
					break;
				case 2:
					parsingMortgage("030200", 1);
					System.out.println("완료되었습니다!!");
					break;
				case 3:
					parsingMortgage("030300", 1);
					System.out.println("완료되었습니다!!");
					break;
				case 4:
					parsingMortgage("050000", 1);
					System.out.println("완료되었습니다!!");
					break;
				case 5:
					parsingMortgage("060000", 1);
					System.out.println("완료되었습니다!!");
					break;
				case 0:
