...
public class BankDeposit {
	private int bankDepositNo; // 일련번호
	...
	private String join_member; // 가입대상s
	...
	public BankDeposit(int bankDepositNo, String dcls_month, String fin_co_no, String kor_co_nm, String fin_prdt_cd,
			...
			String intr_rate_type, String intr_rate_type_nm, String save_trm, double intr_rate, double intr_rate2) {
		super();
	...
	public String toString() {
		return "BankDeposit [bankDepositNo=" + bankDepositNo + ", dcls_month=" + dcls_month + ", fin_co_no=" + fin_co_no
				...
				+ ", save_trm=" + save_trm + ", intr_rate=" + intr_rate + ", intr_rate2=" + intr_rate2 + "]";
	}

	public int getBankDepositNo() {
		return bankDepositNo;
	}

	public void setBankDepositNo(int bankDepositNo) {
		this.bankDepositNo = bankDepositNo;
	}
