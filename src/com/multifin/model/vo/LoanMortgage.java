...
public class LoanMortgage {
	private int loanMortgageNo;	// 일련번호
	...
	public LoanMortgage(int loanMortgageNo, String dcls_month, String fin_co_no, String kor_co_nm, String fin_prdt_cd,
			String fin_prdt_nm, String join_way, String loan_inci_expn, String erly_rpay_fee, String dly_rate,
			long loan_lmt, Date dcls_strt_day, String dcls_end_day, Date fin_co_subm_day, String mrtg_type,
			String mrtg_type_nm, String rpay_type, String rpay_type_nm, String lend_rate_type, String lend_rate_type_nm,
			double lend_rate_min, double lend_rate_max, double lend_rate_avg) {
		super();
		this.loanMortgageNo = loanMortgageNo;
	...
	public int getLoanMortgageNo() {
		return loanMortgageNo;
	}

	public void setLoanMortgageNo(int loanMortgageNo) {
		this.loanMortgageNo = loanMortgageNo;
	}
	...
	public long getLoan_lmt() {
		return loan_lmt;
	}

	public void setLoan_lmt(long loan_lmt) {
		this.loan_lmt = loan_lmt;
	}
	...
	public String toString() {
		return "LoanMortgage [loanMortgageNo=" + loanMortgageNo + ", dcls_month=" + dcls_month + ", fin_co_no="
				...
				+ ", mrtg_type=" + mrtg_type + ", mrtg_type_nm=" + mrtg_type_nm + ", rpay_type=" + rpay_type
				+ ", rpay_type_nm=" + rpay_type_nm + ", lend_rate_type=" + lend_rate_type + ", lend_rate_type_nm="
				+ lend_rate_type_nm + ", lend_rate_min=" + lend_rate_min + ", lend_rate_max=" + lend_rate_max
